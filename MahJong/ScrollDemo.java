...
public class ScrollDemo extends JScrollPane
{
    ...
    public ScrollDemo()
    {
        ...
        discard[0].setBackground(new Color(63, 46, 11));
        discard[1].setBackground(new Color(63, 46, 11));
        panel.setBackground(new Color(63, 46, 11));
    }
